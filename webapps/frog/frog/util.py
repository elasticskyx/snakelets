...
def isSpider(useragent):
    ...
    return re.search("wget|libcurl|bot|zoek|search.msn|scooter|crawl|spider|lycos|yahoo|inktomi|slurp|zyborg|google|askjeeves|teoma|excite|ilse|infoseek|intelli|cfetch", useragent, re.IGNORECASE) is not None
