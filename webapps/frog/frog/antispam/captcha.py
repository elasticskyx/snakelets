...
if __name__=="__main__":
    cg = CaptchaGen("media/ChildsPlay.ttf", (100,80,60), (60,40,30), textsize=32, bgpicture="media/bg.png", noiselines=True, squiggly=True)
    word=createWord(length=6, allowed="ABCDEFGHIJKLMNOPQRSTUVWXYZ")
    print word
